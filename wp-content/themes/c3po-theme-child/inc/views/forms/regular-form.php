...
<form id="ccf-form"
      ...
      novalidate>
       ...
       <fieldset>
              ...
              <input type="hidden" name="ccf-logo-alt" value="Logo de empresa">
       ...
       <div class="legal_advice">
              ...
              <label for="ccf-accept-privacy-advice">
                     ...
                     <input type="checkbox" 
                            ...
                            id="ccf-accept-privacy-advice" checked><small><?php echo C3POCore\Translate::get_term('privacy-accept-phrase'); ?></small>
